...
Then in **Extensions->Reapack->Manage repositories** you should see **DM_ReaperToolkit**. Then click **Browse Packages** and search for **DM_ReaperToolkit** click install and apply.
